     ...
     return (
          <>
               <div>
                    ...
                    <aside className="left-sidebar" data-sidebarbg="skin5" style={{ backgroundColor: 'black' }}>
                         {/* Sidebar scroll*/}
                                   ...
                                   <ul id="sidebarnav" className="p-t-30">
                                        ...
                                        <li className="sidebar-item">
                                             ...
                                             <ul aria-expanded="false" className="collapse  first-level">
                                                  <li className="sidebar-item">
                                                       <Link to="/bookadd" className="sidebar-link">
                                                  ...
                                                  <li className="sidebar-item">
                                                       ...
                                                       >
                                                            ...
                                                            <span className="hide-menu">View Book</span>
                                                       </Link>
                                                  </li>
                                             </ul>
                                        </li>
